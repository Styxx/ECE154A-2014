...
Project 2.1.s is the most recent update of part d
  ...
  It does not output. Nor does it put the correct value in register meant to return the value ($t6) unless it
    is in the trivial case of the exponent being 0.
...
Other ummu.s is the part c code that has been adapted by Mason Levy from internet slides.
  It is fully functional and works. However, it may not be according to the specs given in the project description,
    since it was not adapted from shamu (Ex. 11.4 in the Textbook).
